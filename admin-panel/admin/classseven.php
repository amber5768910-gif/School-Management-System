...
session_start();
  ...
  $msg="" ;
  $i=1;
   $sql=mysqli_query($con, "SELECT * FROM tresult Where class=7");
   ...
   while($ROW=mysqli_fetch_array($sql))
    ...
    $txttype=$ROW['type'];
    $txtdate=$ROW['date'];
    echo "<TR><TD>".$i++."</TD><TD>".$TXTs."</TD><TD>".$TXTclass."</TD><TD>".$txtsub."</TD><TD>". $txtmarks."</TD><TD>".$txtom."</TD><TD>".$txttype."</TD><TD>".$txtdate."</TD><TD><a href=index.php?tag=editseven&id=".$ROW['id'].">EDIT</a></TD><td><a href=index.php?tag=editseven&Did=".$ROW['id'].">DELL</a></td></TR>";
}
            }
