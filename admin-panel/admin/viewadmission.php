...
session_start();
  ...
  $msg="" ;
  $i=1;
   $sql=mysqli_query($con, "SELECT * FROM admissionf");
   ...
   while($ROW=mysqli_fetch_array($sql))
    ...
    $txtphoto=$ROW['photo'];
    echo "<TR><TD>".$i++."</TD><TD>".$TXTNAME."</TD><TD>".$TXTcontact."</TD><TD>".$txtfather."</TD><TD>".$txtclass."</TD><TD>".$txtgender."</TD><TD><img src='".$ROW['photo']."' WIDTH=100 HEIGHT=100></TD><td><a href=index.php?tag=acceptstu&id=".$ROW['id'].">ACCEPT</a></td><td><a href=index.php?tag=acceptstu&Did=".$ROW['id'].">REJECT</a></td></TR>";
}
            }
