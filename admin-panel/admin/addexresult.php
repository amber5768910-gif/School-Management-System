...
if(isset($_POST['btnaddnew']))
    {  
      $id=$_POST['id'];
    $txtstu=$_POST['studentname'];  
    $TXTclass=$_POST['class'];
    $txtsub=$_POST['subject'];
    $txtmarks=$_POST['total_marks'];
    $txtom=$_POST['obtained_marks'];
    $txttype=$_POST['type'];
mysqli_query($con,"INSERT INTO `cms`.`examresult` (`studentname`,`class`,`subject`,`total_marks`,`obtained_marks`,`type`)
values('$_POST[studentname]','$_POST[class]','$_POST[subject]','$_POST[total_marks]','$_POST[obtained_marks]','$_POST[type]')") or die(mysqli_error());    
      ...
      <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-files-o"></i>Add Exam Results</li>
					</ol>
          	</div>
			</div>
