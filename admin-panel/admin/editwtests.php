...
{  
   ...
   $TXTtt=$_POST['ttests'];
    ...
    $txtgt=$_POST['gtime'];
    $txtst=$_POST['stime'];
  $sqll="UPDATE `cms`.`wtests`set `Total_tests`='$_POST[ttests]',`class`='$_POST[class]',`subject`='$_POST[subject]',`marks`='$_POST[marks]', `gtime`='$_POST[gtime]',`stime`='$_POST[stime]' where id=$id" or die(mysqli_error());
...
$linkdid=$_GET['Did'];
if(!empty($linkdid)){
    $sql="delete from wtests where id=".$linkdid."";
...
if(!empty($linkid)){
$sql="select * from wtests where id=".$linkid."";
                      ...
                      <section class="panel">
                          ...
                          <div style="width: 900px; height: auto; float: left;">
                            ...
                            <div class="col-sm-4 form-group" >
								...
								<input type="text"  name="ttests" class="form-control" value="<?php echo $rows['Total_tests']; ?>"/>
							</div>
