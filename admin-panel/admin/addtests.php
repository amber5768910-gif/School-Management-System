...
if(isset($_POST['btnaddnew']))
   ...
   $TXTtt=$_POST['ttests'];
    ...
    $txtgt=$_POST['gtime'];
    $txtst=$_POST['stime'];
mysqli_query($con,"INSERT INTO `cms`.`wtests` (`Total_tests`,`class`,`subject`,`marks`, `gtime`,`stime`)
values('$_POST[ttests]','$_POST[class]','$_POST[subject]','$_POST[marks]','$_POST[gtime]','$_POST[stime]')") or die(mysqli_error());    
                      ...
                      <section class="panel">
                          ...
                          <div style="width: 900px; height: auto; float: left;">
                            <div class="col-sm-4 form-group" >
								...
								<input type="text"  name="ttests" class="form-control" />
							</div>
