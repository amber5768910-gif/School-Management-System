...
mysqli_query($con,"INSERT INTO `cms`.`material` (`name`,`mcondition`,`type`,`amount`,`required`)
values('$_POST[name]','$_POST[condition]','$_POST[type]','$_POST[amount]','$_POST[required]')") or die(mysqli_error());    
...
<script>
      ...
      <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-files-o"></i> Material Management</h3>
					<ol class="breadcrumb">
