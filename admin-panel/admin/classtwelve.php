...
session_start();
  ...
  $i=1;
   ...
   while($ROW=mysqli_fetch_array($sql))
    ...
    $txttype=$ROW['type'];
    $txtdate=$ROW['date'];
    echo "<TR><TD>".$i++."</TD><TD>".$TXTs."</TD><TD>".$TXTclass."</TD><TD>".$txtsub."</TD><TD>". $txtmarks."</TD><TD>".$txtom."</TD><TD>".$txttype."</TD><TD>".$txtdate."</TD><TD><a href=index.php?tag=edittwelve&id=".$ROW['id'].">EDIT</a></TD><td><a href=index.php?tag=edittwelve&Did=".$ROW['id'].">DELL</a></td></TR>";
}
            }
